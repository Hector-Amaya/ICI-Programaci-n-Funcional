...
#Capítulo 9. Ejercicios de recursión

#Hacer un programa recursivo que imprima n(En este caso 10) veces un mensaje:
...
#Crear una función promedio que calcule el promedio de 10
# calificaciones almacenadas en una lista entre 0 y 10:
defmodule Matematicas do
 def sum_list([], suma), do: suma
 def sum_list([head|tail], suma) do
   sum_list(tail, suma+head)

...
#Escriba el problema anterior con un módulo y una función, recibiendo como argumentos la
# cantidad de calificaciones a generar, así como el rango de calificaciones:
...
#Hacer un programa recursivo que cuente de manera creciente de li (límite inferior) a
# ls (límite superior) para li>=ls inclusive:
